...
class Generator:
    ...
    def generate_LRP_last_layer(
        ...
        cam = self.model.bert.encoder.layer[-1].attention.self.get_attn_cam()[
            0
        ]
