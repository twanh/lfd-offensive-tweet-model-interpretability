...
class ColorJitter(object):
    ...
    def __init__(self, brightness=0, contrast=0, saturation=0, hue=0):
        ...
        self.hue = self._check_input(
            hue, 'hue', center=0, bound=(-0.5, 0.5),
    ...
    def get_params(brightness, contrast, saturation, hue):
        ...
        if brightness is not None:
            ...
            transforms.append(
                Lambda(
                    lambda img, tgt: (
                    F.adjust_brightness(img, brightness_factor), tgt,
                    ),
                ),
            )
        ...
        if contrast is not None:
            ...
            transforms.append(
                Lambda(
                    lambda img, tgt: (
                    F.adjust_contrast(img, contrast_factor), tgt,
                    ),
                ),
            )
        ...
        if saturation is not None:
            ...
            transforms.append(
                Lambda(
                    lambda img, tgt: (
                    F.adjust_saturation(img, saturation_factor), tgt,
                    ),
                ),
            )
        ...
        if hue is not None:
            ...
            transforms.append(
                Lambda(
                    lambda img, tgt: (
                    F.adjust_hue(img, hue_factor), tgt,
                    ),
                ),
            )
